...
const { registerUser, loginUser, getProfessors, getAllUsers, updateUserRole, deleteUser, createUser, updateUserAdmin, deleteUsersByRole } = require("../controllers/authController");
