...
const { autoPlan, getSchedules, updateSchedule, deleteSchedule, exportSchedules, exportDocx, deleteAllSchedules } = require("../controllers/scheduleController");
...
router.get("/schedule/export-docx", authMiddleware, exportDocx);
